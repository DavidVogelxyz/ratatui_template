...
use PLACEHOLDER_NAME_core::{ego_tree::NodeId, Command, Config, ConfigValues, ListNode, TabList};
use ratatui::{
...
impl AppState {
    pub fn new(args: Args) -> Self {
        ...
        let tabs = PLACEHOLDER_NAME_core::get_tabs(!args.override_validation);
        ...
        let longest_tab_display_len = tabs
            ...
            .max()
            .unwrap_or(22) as u16; // 22 is the length of "PLACEHOLDER_TITLE" title
    ...
    pub fn get_keybinds(&self) -> (&str, Box<[Shortcut]>) {
        match self.focus {
            ...
            Focus::List => {
                ...
                hints.push(Shortcut::new("Exit PLACEHOLDER_NAME", ["q", "CTRL-c"]));
            ...
            Focus::TabList => (
                "Tab list",
                shortcuts!(
                    ("Exit PLACEHOLDER_NAME", ["q", "CTRL-c"]),
    ...
    pub fn draw(&mut self, frame: &mut Frame) {
        ...
        let label = Paragraph::new(Line::from(vec![
            Span::styled("PLACEHOLDER_TITLE_1 ", Style::default().bold()),
            Span::styled("PLACEHOLDER_TITLE_2", Style::default().italic()),
        ]))
        .block(label_block)
        .centered();
